...
#while True:
    ...
    #text = "the best video player app for android, all the feature are very easy to get used to. some of my videos with eac3 audio couldn't because the codecs weren't available."
